...
public class Main_Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/electronic_storee/Images/Apps-Search-Log-icon.png"))); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 750, 390));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/electronic_storee/Images/أهمية-التسويق-للمتجر-الإلكتروني-1.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        jLabel1.setFocusTraversalPolicyProvider(true);
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1206, -1));

        setSize(new java.awt.Dimension(842, 510));
...
int qps ;
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (qps==0) {
           ...
           // this.Psearch.setVisible(true);
            qps=1;
        }
        else{
           // this.Psearch.setVisible(false);
            qps=0;
            if (this.txt_search.equals(null)) {
                //JOptionPane.showMessageDialog(null, "There is no prudect like is:"+txt_search.getText());
            }else{
                new Search(txt_search.getText());
               // dispose();
